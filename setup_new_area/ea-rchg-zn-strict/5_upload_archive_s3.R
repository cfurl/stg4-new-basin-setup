...
QA_DIR <- "F:/ea-rchg-zn-strict_archive_build/QA_results"

# Local roots (canonical parquet trees)
LOCAL <- list(
  precip_parquet      = "F:/ea-rchg-zn-strict_archive_build/precip/precip_parquet",
  derived_ytd_precip  = "F:/ea-rchg-zn-strict_archive_build/derived_ytd_precip",
  stats_daily         = "F:/ea-rchg-zn-strict_archive_build/stats/daily",
  stats_ytd           = "F:/ea-rchg-zn-strict_archive_build/stats/ytd"
)

# Target S3 prefixes (must end with /)
S3 <- list(
  precip_parquet      = "s3://stg4-24hr-aws-pipeline/CONUS_subset/production_areas/ea-rchg-zn-strict/precip/precip_parquet/",
  derived_ytd_precip  = "s3://stg4-24hr-aws-pipeline/CONUS_subset/production_areas/ea-rchg-zn-strict/derived_ytd_precip/",
  stats_daily         = "s3://stg4-24hr-aws-pipeline/CONUS_subset/production_areas/ea-rchg-zn-strict/stats/daily/",
  stats_ytd           = "s3://stg4-24hr-aws-pipeline/CONUS_subset/production_areas/ea-rchg-zn-strict/stats/ytd/"
)
