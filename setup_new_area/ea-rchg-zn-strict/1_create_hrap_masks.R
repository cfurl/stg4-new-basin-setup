...
epsg_work  <- 3083          # Texas Centric Albers Equal Area
name_field <- "unit_id"    # basin/subbasin name field in Devils dataset

# Inputs
path_hrap_conus_in <- "C:/stg4-hrap-gis/layers/hrap/hrap_conus_integer.shp"

path_mask_in <- paste0(
  "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/gpkg/",
  "ea_full_contrib_rchg_surface_basins.gpkg"
)

path_subbasins_in <- paste0(
  "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/gpkg/",
  "ea_full_contrib_rchg_surface_basins.gpkg"
)
...
root_out <- "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/area_setup"

# Naming prefix for outputs
prefix <- "ea-rchg-zn-strict"
# ============================================================
