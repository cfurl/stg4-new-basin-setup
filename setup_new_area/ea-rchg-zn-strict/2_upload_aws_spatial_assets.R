...
local_1 <- "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/area_setup/prepped/aws/ea-rchg-zn-strict-boundary-mask.parquet"
key_1   <- "CONUS_subset/config/aoi/ea-rchg-zn-strict/assets/ea-rchg-zn-strict-boundary-mask.parquet"
...
# ---------- Upload 2 ----------
local_2 <- "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/area_setup/prepped/aws/ea-rchg-zn-strict-area-vol-calc-masks.parquet"
key_2   <- "CONUS_subset/config/aoi/ea-rchg-zn-strict/assets/ea-rchg-zn-strict-area-vol-calc-masks.parquet"
...
local_3 <- "C:/stg4-hrap-gis/layers/ea-rchg-zn-strict/area_setup/prepped/cells.gpkg"  # <-- fill in
key_3   <- "CONUS_subset/config/aoi/ea-rchg-zn-strict/assets/cells.gpkg"  # <-- fill in
