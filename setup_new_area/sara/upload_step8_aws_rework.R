...
local_1 <- "C:/stg4-hrap-gis/layers/sara/area_setup/prepped/aws/sara-boundary-mask.parquet"
key_1   <- "CONUS_subset/config/aoi/sara/assets/sara-boundary-mask.parquet"
...
# ---------- Upload 2 ----------
local_2 <- "C:/stg4-hrap-gis/layers/sara/area_setup/prepped/aws/sara-area-vol-calc-masks.parquet"
key_2   <- "CONUS_subset/config/aoi/sara/assets/sara-area-vol-calc-masks.parquet"
...
local_3 <- "C:/stg4-hrap-gis/layers/sara/area_setup/prepped/cells.gpkg"  # <-- fill in
key_3   <- "CONUS_subset/config/aoi/sara/assets/cells.gpkg"  # <-- fill in
