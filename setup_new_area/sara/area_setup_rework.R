...
name_field <- "Label"        # subbasin attribute used for filenames + retained as subbasin_name

# Inputs
path_hrap_conus_in <- "C:/stg4-hrap-gis/layers/hrap/hrap_conus_integer.shp"
path_mask_in       <- "C:/stg4-hrap-gis/layers/sara/gis_prep/San_Antonio_River_Watersheds.shp"  # overall AOI mask (may be multi-feature; will be unioned)
path_subbasins_in  <- "C:/stg4-hrap-gis/layers/sara/gis_prep/San_Antonio_River_Watersheds.shp"  # subbasins (multi-feature; used for per-basin outputs)

# Key for validation
path_key_csv <- "C:/stg4-hrap-gis/layers/hrap/grib2_lat_lon_pt_with_grib_decimal_fix.csv"

# Output root for this AOI
root_out <- "C:/stg4-hrap-gis/layers/sara/area_setup"
