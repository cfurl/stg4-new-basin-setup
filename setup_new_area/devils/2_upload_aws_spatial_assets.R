...
local_1 <- "C:/stg4-hrap-gis/layers/devils/area_setup/prepped/aws/devils-boundary-mask.parquet"
key_1   <- "CONUS_subset/config/aoi/devils/assets/devils-boundary-mask.parquet"
...
# ---------- Upload 2 ----------
local_2 <- "C:/stg4-hrap-gis/layers/devils/area_setup/prepped/aws/devils-area-vol-calc-masks.parquet"
key_2   <- "CONUS_subset/config/aoi/devils/assets/devils-area-vol-calc-masks.parquet"
...
local_3 <- "C:/stg4-hrap-gis/layers/devils/area_setup/prepped/cells.gpkg"  # <-- fill in
key_3   <- "CONUS_subset/config/aoi/devils/assets/cells.gpkg"  # <-- fill in
