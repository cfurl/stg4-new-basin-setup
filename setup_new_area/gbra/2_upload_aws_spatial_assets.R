...
local_1 <- "C:/stg4-hrap-gis/layers/gbra/area_setup/prepped/aws/gbra-boundary-mask.parquet"
key_1   <- "CONUS_subset/config/aoi/gbra/assets/gbra-boundary-mask.parquet"
...
# ---------- Upload 2 ----------
local_2 <- "C:/stg4-hrap-gis/layers/gbra/area_setup/prepped/aws/gbra-area-vol-calc-masks.parquet"
key_2   <- "CONUS_subset/config/aoi/gbra/assets/gbra-area-vol-calc-masks.parquet"
...
local_3 <- "C:/stg4-hrap-gis/layers/gbra/area_setup/prepped/cells.gpkg"  # <-- fill in
key_3   <- "CONUS_subset/config/aoi/gbra/assets/cells.gpkg"  # <-- fill in
