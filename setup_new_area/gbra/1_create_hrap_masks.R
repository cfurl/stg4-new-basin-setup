...
path_mask_in       <- "C:/stg4-hrap-gis/layers/gbra/gis_prep2/guad_merge.shp"  # overall AOI mask (may be multi-feature; will be unioned)
path_subbasins_in  <- "C:/stg4-hrap-gis/layers/gbra/gis_prep2/guad_merge.shp"  # subbasins (multi-feature; used for per-basin outputs)

# Key for validation
path_key_csv <- "C:/stg4-hrap-gis/layers/hrap/grib2_lat_lon_pt_with_grib_decimal_fix.csv"

# Output root for this AOI
root_out <- "C:/stg4-hrap-gis/layers/gbra/area_setup"
